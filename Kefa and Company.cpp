...
int main()
{
  ...
  //for(i=0;i<n;i++) cout<<a[i]<<" ";
   // cout<<endl;
    ...
    for(i=1;i<=n;i++)
    {
        cum[i]=cum[i-1]+v[i-1].ss;
    }

   // for(i=0;i<=n;i++) cout<<cum[i]<<" ";
  //  cout<<endl;
    ll ans=LLONG_MIN;
    ...
    for(i=0;i<n;i++)
    {
       // cout<<"I "<<i<<endl;
        ...
        //ll mny=a[i]+d;
      // cout<<"MNY "<<mny<<endl;
        ll idx1=lower_bound(a,a+n,mny)-a;
       // cout<<"IDX "<<idx1<<endl;

       // cout<<"CUM[idx1] "<<cum[idx1]<<" cum[i] "<<cum[i]<<endl;

       //cout<<"POSSIBLE "<<cum[idx1]-cum[i]<<endl;

       ans=max(ans,cum[idx1]-cum[i]);
    }
