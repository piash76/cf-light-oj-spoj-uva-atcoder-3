...
int main()
{
    ...
    while(t--)
    {
        ...
        for(i=1;i<=n;i++)
        {
            ...
            ans[mx]=min(i,ans[mx]);  ///if minimum value is i then max len is mx means for all len from mx to n length subarray min val is i
        }
