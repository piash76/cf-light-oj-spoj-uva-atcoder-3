...
int main()
{
   ...
   cin>>t;
    while(t--)
    {
        f1(i,0,1005) g[i].clear();
        mem(vis,0);mem(level,0);
       ...
       {
           cnt+=no_of_nodes_on_level[i];
       }

       ll chnce;
       if(cnt%2) chnce=0; ///asish
       else chnce =1; ///ayushh
       ...
       if(no_of_nodes_on_level[1]==0) cout<<"Ayush"<<endl;
       else if(no_of_nodes_on_level[1]==1) cout<<"Ayush"<<endl;
       else if(chnce==1) ///ayush
       {
           if((no_of_nodes_on_level[1]-1)%2==0) cout<<"Ayush"<<endl;
           else cout<<"Ashish"<<endl;
       }
       else if(chnce==0)
       {
           if((no_of_nodes_on_level[1]-1)%2==0) cout<<"Ashish"<<endl;
